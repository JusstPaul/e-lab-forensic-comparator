                            ...
                            <div className="px-4 flex flex-col">
                                ...
                                <div>
                                    <RadioGroup
                                        ...
                                        onChange={(event) => {
                                            const nQuestions = data.questions;
                                            nQuestions[index].choices!.type =
                                                event.target.value as Choices;
                                ...
                                <div className="mt-4">
                                    {data.questions[index].choices!.data.map(
                                        (_, idx) => (
                                            <div
                                                key={idx}
                        ...
                        <div className="h-full flex flex-col justify-end md:justify-center">
                            <div className="card-sm py-8 flex flex-col gap-4">
                                <button
                                    ...
                                    name="question"
                                    onClick={() =>
                                        handleAddingQuestions("directions")
                                    }
                                >
                                ...
                                <button
                                    ...
                                    name="question"
                                    onClick={() =>
                                        handleAddingQuestions("question")
                                    }
                                >
                                ...
                                <button
                                    ...
                                    name="comparator"
                                    onClick={() =>
                                        handleAddingQuestions("comparator")
                                    }
                                >
