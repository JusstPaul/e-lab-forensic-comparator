...
const Table = ({ title, additionals, className, children }: Props) => (
  <div
    className={
      'flex flex-1 flex-col md:flex-row mx-2 mt-4 text-left ' + className
    }
  >
    <div className="border-gray-200 rounded border shadow-sm w-full">
      ...
      <div className="p-4 bg-slate-100 overflow-auto">
        <table className="bg-slate-100 table-fixed border-collapse border border-slate-300 w-full rounded">
          {children}
        </table>
      </div>
    </div>
